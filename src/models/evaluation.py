...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='Varutri', repo_name='delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/Varutri/delivery-time-prediction.mlflow")
...
if __name__ == "__main__":
    ...
    sk_model=model,
    artifact_path="delivery_time_pred_model",  # ✅ artifact_path, not name
